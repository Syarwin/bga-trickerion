...
class A17_TestRun extends Assignment
{
    public function __construct($row)
    {
        ...
        $this->abilityText = [
            clienttranslate('You may choose to receive 1 less <trick-marker> on the prepared Trick. If you do, you immediately receive the Trick\'s <fame>, <coin> and <shard> Yields.'),
        ];
    }
}
