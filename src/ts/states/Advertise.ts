...
export class Advertise {
    ...
    onEnteringState(args: AdvertiseArgs, isCurrentPlayerActive: boolean) {
        if (isCurrentPlayerActive) {
            this.bga.statusBar.addActionButton("Advertise", () => this.bga.actions.performAction("actAdvertise"));
        }
    }
     ...
     */
    onLeavingState(args: AdvertiseArgs, isCurrentPlayerActive: boolean) {
    }
