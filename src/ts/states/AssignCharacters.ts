...
export class AssignCharacters {
     ...
     */
    onEnteringState(args: AssignCharactersArgs, isCurrentPlayerActive) {
     ...
     */
    onLeavingState(args: AssignCharactersArgs, isCurrentPlayerActive) {
    }
     ...
     */
    onPlayerActivationChange(args: AssignCharactersArgs, isCurrentPlayerActive) {
