(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined'
        ...
        : typeof define === 'function' && define.amd
          ...
          : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self), factory((global.BgaAnimations = {})));
  ...
  ***************************************************************************** */
    ...
    class BaseAnimationManager {
        ...
        getFullMatrix(element, params) {
            var _a, _b, _c, _d, _e;
            let fromRotationAndScaleMatrix = this.getRotationAndScaleMatrix(
                element,
                (_a = params === null || params === void 0 ? void 0 : params.includeSelfRotationAndScale) !== null &&
                    _a !== void 0
                    ? _a
                    : true
            );
            if (
                (_b = params === null || params === void 0 ? void 0 : params.ignoreScale) !== null && _b !== void 0 ? _b : false
            ) {
                fromRotationAndScaleMatrix = this.removeScaleFromMatrix(fromRotationAndScaleMatrix);
            }
            if (
                (_c = params === null || params === void 0 ? void 0 : params.ignoreRotation) !== null && _c !== void 0
                    ? _c
                    : false
            ) {
            ...
            const horizontalBase =
                (_d = params === null || params === void 0 ? void 0 : params.horizontalBase) !== null && _d !== void 0
                    ? _d
                    : 'center';
            const verticalBase =
                (_e = params === null || params === void 0 ? void 0 : params.verticalBase) !== null && _e !== void 0
                    ? _e
                    : 'center';
        ...
        removeScaleFromMatrix(matrix) {
            ...
            return new DOMMatrix([
                matrix.a / scaleX,
                matrix.b / scaleX, // Normalize X
                matrix.c / scaleY,
                matrix.d / scaleY, // Normalize Y
                matrix.e,
                matrix.f, // Preserve translation
            ]);
        }
        /**
        ...
        removeRotationFromMatrix(matrix) {
            ...
            return new DOMMatrix([
                scaleX,
                0, // Remove rotation from X
                0,
                scaleY, // Remove rotation from Y
                matrix.e,
                matrix.f, // Preserve translation
            ]);
        }
        ...
        addAnimatedSpaceIfNecessary(element, parent, type, animationSettings, insertBefore) {
            ...
            if (type === 'from') {
                placeholderSetting =
                    (_a =
                        animationSettings === null || animationSettings === void 0
                            ? void 0
                            : animationSettings.fromPlaceholder) !== null && _a !== void 0
                        ? _a
                        : 'shrink';
            } else if (type === 'to') {
                placeholderSetting =
                    (_b =
                        animationSettings === null || animationSettings === void 0 ? void 0 : animationSettings.toPlaceholder) !==
                        null && _b !== void 0
                        ? _b
                        : 'grow';
            }
        ...
        wrapOnAnimationSurface(element, positionSettings) {
            ...
            const verticalBase =
                (_a = positionSettings === null || positionSettings === void 0 ? void 0 : positionSettings.verticalBase) !==
                    null && _a !== void 0
                    ? _a
                    : 'center';
            const horizontalBase =
                (_b = positionSettings === null || positionSettings === void 0 ? void 0 : positionSettings.horizontalBase) !==
                    null && _b !== void 0
                    ? _b
                    : 'center';
        ...
        createFadeAnimation(type) {
            return {
                keyframes: [{ opacity: type === 'in' ? 0 : 1 }, { opacity: type === 'in' ? 1 : 0 }],
            };
        }
        /**
        ...
        animateOnAnimationSurface(animationWrapper, fromMatrix, toMatrix, animationSettings) {
            return __awaiter(this, void 0, void 0, function* () {
                var _a;
                const finalSettings = Object.assign(Object.assign({ duration: 500, easing: 'ease-in-out' }, animationSettings), {
                    iterations: 1,
                });
                let keyframes = [{ transform: fromMatrix.toString() }, { transform: toMatrix.toString() }];
                const promises = [animationWrapper.animate(keyframes, finalSettings).finished];
                (_a =
                    animationSettings === null || animationSettings === void 0
                        ? void 0
                        : animationSettings.parallelAnimations) === null || _a === void 0
                    ? void 0
                    : _a
                          .filter((parallelAnimation) => parallelAnimation)
                          .forEach((parallelAnimation) => {
                              ...
                              if (!parallelAnimationElement) {
                                  ...
                                  parallelAnimationElement =
                                      applyTo === 'wrapper' ? animationWrapper : this.getElementInWrapper(animationWrapper);
                                  if (applyTo === 'intermediate') {
                                      parallelAnimationElement = this.addWrapperLayer(animationWrapper);
                                  }
                              }
                              promises.push(
                                  parallelAnimationElement.firstElementChild.animate(parallelAnimation.keyframes, finalSettings)
                                      .finished
                              );
                          });
        ...
        startSlideInAnimation(element, fromElement, fromIgnoreScale = true, fromIgnoreRotation = true, preserveScale = true) {
            ...
            const toMatrix = this.getFullMatrix(element, {
                ...
                includeSelfRotationAndScale: false,
            });
         ...
         */
        startAttachAnimation(element, toElement, insertBefore, fromPlaceholder, toPlaceholder) {
            const fromParent = element.parentElement;
            const fromNextSibling = element.nextElementSibling;
            let wrapper;
            let fromMatrix;
            ...
            if (fromPlaceholder && toPlaceholder) {
                ...
                fromMatrix = this.getFullMatrix(fromPlaceholder, {
                    ignoreScale: false,
                    ignoreRotation: false,
                    includeSelfRotationAndScale: false,
                });
                toMatrix = this.getFullMatrix(toPlaceholder, {
                    ignoreScale: false,
                    ignoreRotation: false,
                    includeSelfRotationAndScale: false,
                });
            } else {
                fromMatrix = this.getFullMatrix(element, {
                    ignoreScale: false,
                    ignoreRotation: false,
                    includeSelfRotationAndScale: false,
                });
                ...
                toMatrix = this.getFullMatrix(element, {
                    ignoreScale: false,
                    ignoreRotation: false,
                    includeSelfRotationAndScale: false,
                });
        ...
        pausePlaceholderGrowAnimations() {
            this.growingPlaceholderAnimations = this.growingPlaceholderAnimations.filter(
        ...
        endRunningAnimation(runningAnimation) {
            ...
            if (runningAnimation.element) {
                ...
                this.attachToElement(
                    runningAnimation.element,
                    runningAnimation.toParent,
                    (_a = runningAnimation.toSpaceWrapper) !== null && _a !== void 0 ? _a : runningAnimation.toNextSibling
                );
            }
            (_b = runningAnimation.wrappersToRemove) === null || _b === void 0
                ? void 0
                : _b.forEach((wrapper) => this.removeElement(wrapper));
        }
        /**
    ...
    class AnimationManager {
        ...
        slideAndAttach(element, toElement, animationSettings, insertBefore) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const fromPlaceholder =
                    (allAnimationSettings === null || allAnimationSettings === void 0
                        ? void 0
                        : allAnimationSettings.fromPlaceholder) === 'on'
                ...
                const toPlaceholder =
                    (allAnimationSettings === null || allAnimationSettings === void 0
                        ? void 0
                        : allAnimationSettings.toPlaceholder) === 'on'
                        ? this.base.addFixedSpace(element, toElement, insertBefore)
                        : null;
                const runningAnimation = this.base.startAttachAnimation(
                    element,
                    toElement,
                    insertBefore,
                    fromPlaceholder,
                ...
                const finalAnimationSettings = Object.assign(Object.assign({}, allAnimationSettings), {
                    parallelAnimations: [
                        this.base.createBumpAnimation(
                            (_a =
                                allAnimationSettings === null || allAnimationSettings === void 0
                                    ? void 0
                                    : allAnimationSettings.bump) !== null && _a !== void 0
                                ? _a
                                : 1.2
                        ),
                        ...((_b =
                            allAnimationSettings === null || allAnimationSettings === void 0
                                ? void 0
                                : allAnimationSettings.parallelAnimations) !== null && _b !== void 0
                            ? _b
                            : []),
                    ],
                });
                yield Promise.all(
                    [
                        !toPlaceholder
                            ? this.base.addAnimatedSpaceIfNecessary(element, toElement, 'to', allAnimationSettings, insertBefore)
                            : null,
                        this.base.animateOnAnimationSurface(
                            wrapper,
                            fromMatrix,
                            toMatrix,
                            Object.assign({ easing: 'ease-in-out' }, finalAnimationSettings)
                        ),
                        !fromPlaceholder
                            ? this.base.addAnimatedSpaceIfNecessary(
                                  element,
                                  fromParent,
                                  'from',
                    ...
                    var _a;
                    runningAnimation.toSpaceWrapper =
                        toPlaceholder !== null && toPlaceholder !== void 0
                            ? toPlaceholder
                            : (_a = results[0]) === null || _a === void 0
                              ? void 0
                              : _a.animationWrapper;
                    runningAnimation.wrappersToRemove.push(
                        ...results.map((result) => (result === null || result === void 0 ? void 0 : result.animationWrapper))
                    );
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!this.animationsActive()) {
                    elements.forEach((element, index) =>
                        this.base.attachToElement(element, parents[1 - index], nextSiblings[1 - index])
                    );
                    return;
                }
                const allAnimationSettings = Object.assign(Object.assign({}, this.animationSettings), animationSettings);
                ...
                const matrixes = elements.map((element) =>
                    this.base.getFullMatrix(element, {
                        ignoreScale: false,
                        ignoreRotation: false,
                        includeSelfRotationAndScale: false,
                    })
                ...
                yield Promise.all(
                    elements.map((element, index) =>
                        Promise.all([
                            ...
                            this.base.attachToElement(
                                element,
                                parents[1 - index],
                                (_b = (_a = results[0]) === null || _a === void 0 ? void 0 : _a.animationWrapper) !== null &&
                                    _b !== void 0
                                    ? _b
                                    : nextSiblings[1 - index]
                            );
                            results.forEach((result) =>
                                this.base.removeElement(result === null || result === void 0 ? void 0 : result.animationWrapper)
                            );
                        })
                    )
                );
        ...
        sequenceAnimationsAttach(element, toElement, animations, animationSettings, insertBefore) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (Array.isArray(animationSettings) && animationSettings.length !== animations.length) {
                    throw new Error(
                        'slideToScreenCenterAndAttach animationSettings array must be made of as many elements as animations'
                    );
                }
                for (let index = 0; index < animations.length; index++) {
                    const currentAnimation = animations[index];
                    const currentAnimationSettings = Array.isArray(animationSettings)
                        ? Object.assign(Object.assign({}, this.animationSettings), animationSettings[index])
                        : Object.assign(Object.assign({}, this.animationSettings), animationSettings);
                    const promises = [currentAnimation(runningAnimation, currentAnimationSettings)];
                    if (index === 0) {
                        // shrinking animation
                        promises.push(
                            this.base.addAnimatedSpaceIfNecessary(
                                element,
                                runningAnimation.fromParent,
                                'from',
                                currentAnimationSettings,
                                runningAnimation.fromNextSibling
                            )
                        );
                    }
                    ...
                    if (index === 0) {
                        // remove shrinking animation
                        this.base.removeElement((_a = results[1]) === null || _a === void 0 ? void 0 : _a.animationWrapper);
                    }
                    if (index === animations.length - 1) {
                        runningAnimation.toSpaceWrapper =
                            (_b = results[animations.length - 1]) === null || _b === void 0 ? void 0 : _b.animationWrapper;
                        runningAnimation.wrappersToRemove.push(
                            ...results.map((result) => (result === null || result === void 0 ? void 0 : result.animationWrapper))
                        );
                    }
                    ...
                    if (currentAnimationSettings.innerPause && index < animations.length - 1) {
                        yield this.base.animateOnAnimationSurface(
                            runningAnimation.wrapper,
                            runningAnimation.fromMatrix,
                            runningAnimation.fromMatrix,
                            { duration: currentAnimationSettings.innerPause }
                        );
                    }
                }
                this.base.endRunningAnimation(runningAnimation);
        ...
        slideToScreenCenterAndAttach(element, toElement, animationSettings, insertBefore) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const centerScreenMatrix = new DOMMatrix().translateSelf(
                    window.scrollX + (window.innerWidth - elementBR.width) / 2,
                    window.scrollY + (window.innerHeight - elementBR.height) / 2
                );
                const toCenterScreen = (runningAnimation, animationSettings) =>
                ...
                const toFinalPlace = (runningAnimation, animationSettings) =>
                    __awaiter(this, void 0, void 0, function* () {
                        yield this.base.animateOnAnimationSurface(
                            runningAnimation.wrapper,
                            runningAnimation.fromMatrix,
                            runningAnimation.toMatrix,
                            animationSettings
                        );
                        return runningAnimation;
                    });
                return yield this.sequenceAnimationsAttach(
                    element,
                    toElement,
                    [toCenterScreen, toFinalPlace],
                    animationSettings,
                    insertBefore
                );
            });
        ...
        slideIn(element, fromElement, animationSettings) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const runningAnimation = this.base.startSlideInAnimation(
                    element,
                    fromElement,
                    (_a = animationSettings === null || animationSettings === void 0 ? void 0 : animationSettings.ignoreScale) !==
                        null && _a !== void 0
                        ? _a
                        : true,
                    (_b =
                        animationSettings === null || animationSettings === void 0
                            ? void 0
                            : animationSettings.ignoreRotation) !== null && _b !== void 0
                        ? _b
                        : true,
                    (_c = allAnimationSettings.preserveScale) !== null && _c !== void 0 ? _c : true
                );
                ...
                const promises = [
                    ...
                    this.base.animateOnAnimationSurface(
                        ...
                        fromMatrix,
                        toMatrix,
                        Object.assign({ easing: 'ease-out' }, allAnimationSettings)
                    ),
                ];
        ...
        fadeIn(element, fromElement, animationSettings) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const finalAnimationSettings = Object.assign(Object.assign({}, allAnimationSettings), {
                    parallelAnimations: [
                        this.base.createFadeAnimation('in'),
                        ...((_a =
                            animationSettings === null || animationSettings === void 0
                                ? void 0
                                : animationSettings.parallelAnimations) !== null && _a !== void 0
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const runningAnimation = this.base.startSlideOutAnimation(
                    ...
                    (_b =
                        ...
                        ? _b
                        : false,
                    (_c = animationSettings.preserveScale) !== null && _c !== void 0 ? _c : true
                );
                const { wrapper, fromMatrix, toMatrix } = runningAnimation;
                yield Promise.all([
                    this.base.addAnimatedSpaceIfNecessary(
                    ...
                    this.base.animateOnAnimationSurface(
                        ...
                        fromMatrix,
                        toMatrix,
                        Object.assign(Object.assign({ easing: 'ease-in' }, this.animationSettings), finalAnimationSettings)
                    ),
                ]).then((results) => {
                    this.base.removeElement(element);
        ...
        fadeOutAndDestroy(element, toElement, animationSettings) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const finalAnimationSettings = Object.assign(Object.assign({}, allAnimationSettings), {
                    parallelAnimations: [
                        this.base.createFadeAnimation('out'),
                        ...((_a =
                            animationSettings === null || animationSettings === void 0
                                ? void 0
                                : animationSettings.parallelAnimations) !== null && _a !== void 0
        ...
        getFloatingElementParams(animationSettings, defaultAnimation) {
            ...
            if (defaultAnimation && ((_a = allAnimationSettings.defaultAnimation) !== null && _a !== void 0 ? _a : true)) {
                allAnimationSettings.parallelAnimations = [
                    defaultAnimation,
                    ...((_b =
                        animationSettings === null || animationSettings === void 0
                            ? void 0
                            : animationSettings.parallelAnimations) !== null && _b !== void 0
                        ? _b
                        : []),
                ];
            }
        ...
        slideFloatingElement(element, fromElement, toElement, animationSettings) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const toMatrix = DOMMatrix.fromMatrix(
                    this.base.getFullMatrix(
                        toElement,
                        Object.assign(
                            { ignoreScale: true, ignoreRotation: true, includeSelfRotationAndScale: false },
                            allAnimationSettings.toSettings
                        )
                    )
                );
                const fromMatrix = DOMMatrix.fromMatrix(
                    fromElement
                        ? this.base.getFullMatrix(
                              fromElement,
                              Object.assign(
                                  { ignoreScale: true, ignoreRotation: true, includeSelfRotationAndScale: false },
                                  allAnimationSettings.fromSettings
                              )
                          )
                        : toMatrix
                );
                if (
                    (_a = animationSettings === null || animationSettings === void 0 ? void 0 : animationSettings.scale) !==
                        null && _a !== void 0
                        ? _a
                        : 1 !== 1
                ) {
        ...
        addDisplayElementAnimationSettings(element, animationSettings) {
            var _a;
            let extraClasses =
                (_a = animationSettings === null || animationSettings === void 0 ? void 0 : animationSettings.extraClasses) !==
                    null && _a !== void 0
                    ? _a
                    : [];
        ...
        displayMessage(toElement, message, color, animationSettings) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const finalAnimationSettings = this.getFloatingElementParams(
                    Object.assign({ duration: 2000 }, animationSettings),
                    zoomInOutAnimation
                );
        ...
        displayBubble(toElement, message, animationSettings) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (finalAnimationSettings.toSettings.verticalBase && !finalAnimationSettings.fromSettings.verticalBase) {
                    finalAnimationSettings.fromSettings.verticalBase =
                        finalAnimationSettings.toSettings.verticalBase === 'bottom' ? 'top' : 'bottom';
                }
        ...
        playInterval(animations, interval = this.animationSettings.duration / 4) {
            return new Promise((resolve) => {
                ...
                let index = 0;
                const promises = [animations[index](index)];
                index++;
    ...
    exports.BgaAnimations = BgaAnimations;
    exports.Manager = AnimationManager;
});
